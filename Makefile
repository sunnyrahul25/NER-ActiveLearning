...
process-data: ## Clean logs
	rm -rf data/processed/
	python scripts/dataset/conll2003.py
	python scripts/dataset/mit-restaurant.py
	python scripts/dataset/atco_2.py
	python scripts/dataset/atc_500.py
	python scripts/dataset/airbus.py
